...
const icons: Record<string, React.ReactNode> = {
  ...
  email: (
    <path d="M1.5 5.25A2.25 2.25 0 0 1 3.75 3h16.5a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 20.25 21H3.75a2.25 2.25 0 0 1-2.25-2.25zm2.4-.15 8.1 6.08 8.1-6.08zM21 6.9l-8.55 6.41a.75.75 0 0 1-.9 0L3 6.9v11.85c0 .41.34.75.75.75h16.5c.41 0 .75-.34.75-.75z" />
  ),
};
